...
function renderPlayerCard(
  ...
  if (player.Name === "Empty" || player.Name === "Open") {
    const warningClass = isCommanderSlot
  ...
  let originalName = player.OriginalName
  ...
  let steamNickname = "";
  let steamAvatarUrl =
    player.Name === "Computer" ? "/img/computer.png" : "/img/no_steam_pfp.jpg";
  ...
  if (
    ...
    if (SteamPlayerList && SteamPlayerList[steamId]) {
      ...
      steamAvatarUrl =
        SteamPlayerList[steamId].AvatarUrl || "/img/no_steam_pfp.jpg";
    }
  }
  // Handle GOG players
  else if (
    ...
    if (GogPlayerList && GogPlayerList[gogId]) {
      ...
      steamAvatarUrl =
        GogPlayerList[gogId].AvatarUrl || "/img/no_steam_pfp.jpg";
    }
  }
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center${
          player.Name === "Computer" ? " no-hover computer-team" : ""
            ...
            <div class="d-flex align-items-center">
                ${
                  !compactPlayerCards
                    ? `<img src="${steamAvatarUrl}" class="me-2 img-thumbnail" width="48" height="48" onError="this.src='/img/no_steam_pfp.jpg'">`
                    : ""
                }
                <div>
  ...
  try {
    ...
    GameList.forEach((game, index) => {
      ...
      if (gameMod !== undefined && !hasPassword && !isLocked) {
        ...
        let shortIOPath =
          game.Address && game.Address.NAT
            ? game.Address.NAT.replaceAll("@", "A")
                .replaceAll("-", "0")
                .replaceAll("_", "L")
            : "";
        ...
        fetch("https://api.short.io/links/public", options)
          ...
          .then((response) => {
            ...
            ).innerText = `${options.playerCount}/${options.playerCountMax} ${response.shortURL} @BZ2Player`;
          })
